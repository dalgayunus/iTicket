    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('customer', 'Customer'), ('organizer', 'Organizer'), ('admin', 'Admin')], default='customer', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('purpose', models.CharField(choices=[('activation', 'Activation'), ('login', 'Login'), ('password_reset', 'Password Reset')], max_length=16)),
